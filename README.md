...
<head>
    ...
    <title>Bem-vindo ao Meu GitHub!</title>
    <style>
        body {
...
<body>
    ...
    <ul>
        ...
        <li>📚 <strong>Formação:</strong>
            <ul>
                <li><strong>Computação Forense e Segurança da Informação</strong> - Pós-graduação: Especialização em proteção de dados, produção de laudos e pareceres, análise de vestígios cibernéticos e recuperação de evidências.</li>
    ...
    <h2>🚀 Projetos</h2>
    <ul>
        <li><strong>Projeto X</strong> - Descrição breve do Projeto X e seus objetivos.</li>
        <li><strong>Projeto Y</strong> - Descrição breve do Projeto Y e seus objetivos.</li>
    </ul>
    ...
    <div class="logo">
        <a href="https://apecof.org.br" target="_blank">
            <img src="https://apecof.org.br/images/APECOF/APECOF_JPG.jpeg" alt="APECOF" />
        </a>
        <a href="https://www.fortalsec.org" target="_blank">
            <img src="https://media.licdn.com/dms/image/D4D0BAQE7T1lh7KL4LA/company-logo_200_200/0/1706533102362/fortalsec_logo?e=1730332800&v=beta&t=sr9fRz9IHsoRYZcZ3meVsI1n69hCou6BVc1Mwrdcsck" alt="FORTALSEC" />
        </a>
    </div>
